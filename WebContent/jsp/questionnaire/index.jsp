...
<div class="page-content">
      <div class="page-header fixed-div">
        <p>
          <lable>问卷名称：</lable><input type="text" id="name"/>
         ...
         <div id="table-result">
          ...
          <div class="table-responsive"> 
           <div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid">
              <div class="row" >
              <div class="col-sm-6"><div id="pager"><label >显示 <select size="1" onchange="javascript:gotoPage(1,'id=&name=&typeId=&typeName=')" id="p_pageSizeSelect">
              ...
              <table id="table" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info"> 
               <thead> 
                <tr role="row"> 
                 ...
                 <th  role="columnheader"  rowspan="1" colspan="1" style="width: 153px;" >问卷名称</th> 
	...
	jQuery(function($) {
	    $("#search").click(function () {
	           ...
	           gotoPage(1,"id="+"&name="+name+"&typeId="+"&typeName="+typeName);
	    });
	    
		/* 获取数据 */
		gotoPage(1,"id=&name=&typeId=&typeName=");
		...
		$.ajax({
			...
			success : function(msg) {
				if(msg.page.totalElement == 0){
					$('#tb').append("<tr><td colspan="+5+"><div class='alert alert-block alert-danger'><div class='danger bold-center'>没结果</div><div></td></tr>");
					$('#pages').html("");
					$("#other").html("");
				}else{
