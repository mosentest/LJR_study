         ...
         <div id="table-result">
          ...
          <div class="table-responsive"> 
           <div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid">
              <div class="row" >
              <div class="col-sm-6"><div id="pager"><label >显示 <select size="1" onchange="javascript:gotoPage(1,'id=&username=')" id="p_pageSizeSelect">
              ...
              <table id="table" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info"> 
               <thead> 
                <tr role="row"> 
                 ...
                 <th role="columnheader"  rowspan="1" colspan="1" style="width: 130px;" >最后登录日期</th> 
				...
				if(msg.page.totalElement == 0){
					...
					$.each(msg.page.content, function(i, item) {
			              $('#tb').append( "<tr>"
			            		  ...
			            		  +"<td >"+item.username+"</td> "
			            		  +"<td >"+item.name+"</td> "
			            		  +"<td >"+getSmpFormatDateByLong(item.loginTime,"yyyy-MM-dd")+"</td> "
			            		  +"<td >"+"<div class='visible-md visible-lg hidden-sm hidden-xs action-buttons' id='buttontools'>"
			            		  				+"<a class='green' href='user/showOne.html?id="+item.id+"' > <i class='icon-pencil bigger-130'></i> </a>"
			            		  				+"<a class='red' href='user/delete?id="+item.id+"' > <i class='icon-trash bigger-130'></i> </a>"
			            		  				+"</td> "+"</tr>");
			            });
